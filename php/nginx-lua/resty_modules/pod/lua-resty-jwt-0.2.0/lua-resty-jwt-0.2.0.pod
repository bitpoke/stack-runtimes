...
[!L<Build Status|https://img.shields.io/travis/cdbattags/lua-resty-jwt.svg?style=flat-square>](https://travis-ci.org/cdbattags/lua-resty-jwt)
...
opm: C<opm get SkyLothar/lua-resty-jwt> (to be updated soon)
...
Head to L<release page|https://github.com/cdbattags/lua-resty-jwt/releases> and download C<tar.gz>
